...
#this works and creates a menu of info per item (see screenshot)
# df = pd.read_csv('MtnCameras.csv')
# for i, j in df.iterrows():
#     print(i, j)
#     print()

#This works and creats an array with Index #s)
df = pd.read_csv('MtnCameras.csv')
for row in df.itertuples():
    print(row)

#this csv works but doesn't iterate through rows, saving, naming and uploading images to s3.
# df = pd.read_csv('MtnCameras.csv')
# for i ,row in df.iterrows():
#         value = print(f"{row['url_front']}")
